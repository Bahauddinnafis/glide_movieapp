...
import com.nafis.glidemovieapp.ui.theme.primaryLightHighContrast
    ...
    Box(modifier = modifier.fillMaxWidth()) {
        GlideImage(
            ...
            onSuccess = { bitmap ->
                ...
                Log.d("LoadingTime", "Glide loading time for ${movieDetail.title}: $loadingTime ms")
            ...
            onError = { error ->
                ...
                val endTime = System.nanoTime()
                val loadingTime = (endTime - startTime) / 1_000_000
                Log.d("LoadingTime", "Glide loading failed for ${movieDetail.title}: $loadingTime ms")
                detailViewModel.addLoadingTime(movieDetail.title, imageUrl, loadingTime)
            }
        )
