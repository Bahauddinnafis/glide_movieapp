...
import com.nafis.glidemovieapp.movie_detail.domain.models.Review
import com.nafis.glidemovieapp.ui.CustomSnackbar
import com.nafis.glidemovieapp.ui.favorite.FavoriteViewModel
import com.nafis.glidemovieapp.ui.home.components.MovieCard
import com.nafis.glidemovieapp.ui.home.components.MovieCoverImage
import com.nafis.glidemovieapp.ui.home.defaultPadding
                        ...
                        LazyRow(
                            ...
                            items(movieDetail.cast) { cast ->
                                ActorItem(
                                    ...
                                    imageUrl = if (cast.profilePath.isNullOrEmpty()) {
                                        "https://via.placeholder.com/92" // URL placeholder
                                    } else {
                                        "${
