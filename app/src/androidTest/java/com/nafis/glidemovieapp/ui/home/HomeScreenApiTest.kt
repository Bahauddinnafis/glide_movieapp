package com.nafis.glidemovieapp.ui.home
...
import com.nafis.glidemovieapp.MainActivity
import com.nafis.glidemovieapp.di.MovieDetailModule.provideMovieDetailApiService
import com.nafis.glidemovieapp.di.MovieDetailModule.provideMovieDetailMapper
import com.nafis.glidemovieapp.di.MovieDetailModule.provideMovieListMapper
import com.nafis.glidemovieapp.movie_detail.data.repository_impl.MovieDetailRepositoryImpl
import com.nafis.glidemovieapp.movie_detail.domain.repository.MovieDetailRepository
import com.nafis.glidemovieapp.ui.detail.DetailViewModel
import com.nafis.glidemovieapp.utils.extractLoadingTimesFromLogcat
import com.nafis.glidemovieapp.utils.writeLoadingTimesToExcel
import com.nafis.glidemovieapp.utils.writeLogcatLoadingTimesToExcel
...
class HomeScreenApiTest {
    ...
    @Test
    fun testWithRealApiGlide() = runTest(timeout = 300.seconds) {
        ...
        do {
            filePath = "${downloadsDir.absolutePath}/loading_times_glide_logcat_running_$fileIndex.xlsx"
            fileIndex++
        } while (File(filePath).exists())
